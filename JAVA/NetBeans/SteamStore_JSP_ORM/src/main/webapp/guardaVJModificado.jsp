...
<html>
    ...
    <body>
        <%
            ...
            //Invoca la operación del gestor que permite actualizar los datos de un videojuego (que se pasan como parámetros) de la lista general (esta operación puede arrojar excepciones que hay que controlar)
            try {
            ...
            //Comprueba el resultado obtenido y muestra un mensaje de éxito (entre etiquetas <div>) si la operación se realizó satisfactoriamente
                if(miGestor.update(miJuego)){
                    out.println("<div> Juego modificado correctamente</div>");
                }else{
                    out.println("El juego no se ha modificado correctamente");
                }
