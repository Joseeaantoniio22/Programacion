        ...
        <div class="container">
            ...
            <div class="row s12 m12 l12">
                <div class="card light-blue lighten-5">
                    <h2 class="center" style="color:#006064"><b>Modificar videojuego</b></h2>
                            ...
                            <tr>
                                <td>
                                    <div class="input-field">
                                        <input type="number" name="identificador" id="identificador" value="<%=request.getParameter("identificador") %>" required readonly>
